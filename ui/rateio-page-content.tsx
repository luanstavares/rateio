        ...
        <div className="rounded-lg border border-border bg-card p-6 sm:p-8">
          ...
          <div className="mt-4 rounded-md border border-border bg-primary/5 p-4">
            <p className="text-sm text-muted-foreground">
              Quer guardar sua participação e este histórico na sua conta?
            </p>
      ...
      <div className="rounded-lg border border-border bg-card p-6 sm:p-8">
        {claimStatus === 'success' ? (
          <div
            ...
            role="status"
          >
            Sua participação anônima foi vinculada à sua conta. Este rateio
        ...
        {claimStatus === 'error' ? (
          <div
            ...
            role="alert"
          >
            Não foi possível vincular sua participação anônima à conta. Sua
            sessão compartilhada não foi alterada; você pode tentar novamente.
            <a
        ...
        {isOwner && currentMember ? (
          <>
            <RateioStatusControl status={rateio.status} />
