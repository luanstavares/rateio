...
type AllocationResult =
  { allocations: CreateManualExpenseInput['allocations'] } | { error: string };
        ...
        <div className="mx-auto flex min-h-0 w-full max-w-2xl flex-1 flex-col">
          <div className="flex shrink-0 items-start justify-between gap-4">
            <DrawerHeader className="items-start">
              ...
              <DrawerDescription className="mt-2">
                Registre um item em {baseCurrency} e escolha como dividir a
                conta.
              </DrawerDescription>
            </DrawerHeader>
            <DrawerClose asChild>
          ...
          >
            ...
            <DrawerFooter className="mt-6 shrink-0 flex-col-reverse gap-3 p-0 sm:flex-row sm:justify-end">
              ...
              <Button disabled={addExpense.isPending} type="submit">
                {addExpense.isPending ? 'Adicionando...' : 'Adicionar item'}
              </Button>
            </DrawerFooter>
          </form>
        </div>
